                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="email-left-box generic-width px-0 mb-5">
                                    <div class="p-0">
                                        <a href="<?php echo base_url('dashboard/email_compose');?>" class="btn btn-primary btn-block">Compose</a>
                                    </div>
                                    <div class="mail-list mt-4">
                                        <a href="<?php echo base_url('dashboard/email');?>" class="list-group-item active"><i
                                    ...
                                    <div class="mail-list mt-4">
                                        <a href="<?php echo base_url('dashboard/email');?>" class="list-group-item"><span class="icon-warning"><i
                                                    class="fa fa-circle" aria-hidden="true"></i></span>
                                            Work </a>
                                        <a href="<?php echo base_url('dashboard/email');?>" class="list-group-item"><span class="icon-primary"><i
                                                    class="fa fa-circle" aria-hidden="true"></i></span>
                                            Private </a>
                                        <a href="<?php echo base_url('dashboard/email');?>" class="list-group-item"><span class="icon-success"><i
                                                    class="fa fa-circle" aria-hidden="true"></i></span>
                                            Support </a>
                                        <a href="<?php echo base_url('dashboard/email');?>" class="list-group-item"><span class="icon-dpink"><i
                                                    class="fa fa-circle" aria-hidden="true"></i></span>
                                            Social </a>
                                    </div>
                                </div>
                                            ...
                                            <div class="right-box-padding">
                                                ...
                                                <div class="read-content">
                                                    <div class="media pt-3">
														<img class="mr-2 rounded" width="50" alt="image" src="<?php echo base_url('assets/images/avatar/1.jpg');?>">
