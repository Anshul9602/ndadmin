      ...
      <div class="tab-content" id="menu">
         <div class="tab-pane fade show " id="dashboard" role="tabpanel">
            <ul class="metismenu tab-nav-menu">
               ...
               <li>
                  <a class="has-arrow" href="<?php echo base_url('dashboard');?>" aria-expanded="false">
                     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
               ...
               <li>
                  <a class="has-arrow" href="<?php echo base_url('dashboard/calendar');?>" aria-expanded="false">
         ...
         <div class="tab-pane fade" id="forms">
            <ul class="metismenu tab-nav-menu">
               ...
               <li>
                  <a class="has-arrow" href="<?php echo base_url('catalog/category_list');?>" aria-expanded="false">
                     <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24"/>
               ...
               <li>
                  <a class="has-arrow" href="<?php echo base_url('catalog/unit_product_list');?>" aria-expanded="false">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24"/>
               ...
               <li class="nav-item dropdown header-profile">
                  <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                     ...
                     <div class="header-info">
                        <span>Hey, <strong>Ronak</strong></span>
